...
const ClassroomCreate = (subjectName, name, redirectText, redirectLink) => {
    return `
    <!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body class="bg-gray-50">
    <div class="max-w-md mx-auto p-6 bg-white shadow-lg rounded-lg my-6">
      ...
      <!-- Email Title -->
      <h1 class="text-2xl font-bold text-blue-800 mt-6">New Assignment Posted - ${subjectName}</h1>
      ...
      <div class="mt-4 space-y-3 text-gray-600 text-sm">
        <p>A new assignment has been posted for ${subjectName}.</p>
      </div>
