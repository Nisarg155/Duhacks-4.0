...
const ClassroomCreate = (submissionStatus, assignmentTitle, name, redirectText, redirectLink) => {
    return `
    <!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>${submissionStatus} Assignment - ${assignmentTitle}</title>
  ...
  <body class="bg-gray-50">
    <div class="max-w-md mx-auto p-6 bg-white shadow-lg rounded-lg my-6">
      ...
      <!-- Email Title -->
      <h1 class="text-2xl font-bold text-blue-800 mt-6">${submissionStatus} Assignment - ${assignmentTitle}</h1>
      ...
      <div class="mt-4 space-y-3 text-gray-600 text-sm">
        <p>This is regarding your ward's ${submissionStatus} assignment submission.
</p>
      </div>
